.class public final Lvendor/qti/ims/configservice/V1_0/SettingsValues;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->boolData:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->intData:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->stringData:Ljava/util/ArrayList;
...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            ")",
            "Ljava/util/ArrayList<",
            "Lvendor/qti/ims/configservice/V1_0/SettingsValues;",
            ">;"
        }
    .end annotation
    ...
    .line 62
    .local v0, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lvendor/qti/ims/configservice/V1_0/SettingsValues;>;"
    ...
    .line 72
    new-instance v5, Lvendor/qti/ims/configservice/V1_0/SettingsValues;

    invoke-direct {v5}, Lvendor/qti/ims/configservice/V1_0/SettingsValues;-><init>()V

    .line 73
    .local v5, "_hidl_vec_element":Lvendor/qti/ims/configservice/V1_0/SettingsValues;
    mul-int/lit8 v6, v4, 0x30

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V

    .line 74
    invoke-virtual {v0, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 71
    .end local v5    # "_hidl_vec_element":Lvendor/qti/ims/configservice/V1_0/SettingsValues;
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    .line 132
    .local p1, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lvendor/qti/ims/configservice/V1_0/SettingsValues;>;"
    ...
    check-cast v4, Lvendor/qti/ims/configservice/V1_0/SettingsValues;

    mul-int/lit8 v5, v3, 0x30

    int-to-long v5, v5

    invoke-virtual {v4, v2, v5, v6}, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v3, Lvendor/qti/ims/configservice/V1_0/SettingsValues;
    ...
    check-cast v2, Lvendor/qti/ims/configservice/V1_0/SettingsValues;

    .line 21
    .local v2, "other":Lvendor/qti/ims/configservice/V1_0/SettingsValues;
    iget-object v3, p0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->boolData:Ljava/util/ArrayList;

    iget-object v4, v2, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->boolData:Ljava/util/ArrayList;
    ...
    .line 24
    :cond_3
    iget-object v3, p0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->intData:Ljava/util/ArrayList;

    iget-object v4, v2, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->intData:Ljava/util/ArrayList;
    ...
    .line 27
    :cond_4
    iget-object v3, p0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->stringData:Ljava/util/ArrayList;

    iget-object v4, v2, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->stringData:Ljava/util/ArrayList;
...
.method public final hashCode()I
    ...
    .line 35
    iget-object v0, p0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->boolData:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->intData:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->stringData:Ljava/util/ArrayList;
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iget-object v2, v0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->boolData:Ljava/util/ArrayList;
    ...
    .line 93
    iget-object v4, v0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->boolData:Ljava/util/ArrayList;
    ...
    iget-object v2, v0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->intData:Ljava/util/ArrayList;
    ...
    .line 106
    iget-object v4, v0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->intData:Ljava/util/ArrayList;
    ...
    .line 115
    .restart local v1    # "childBlob":Landroid/os/HwBlob;
    iget-object v2, v0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->stringData:Ljava/util/ArrayList;
    ...
    .line 119
    iget-object v4, v0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->stringData:Ljava/util/ArrayList;
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final toString()Ljava/lang/String;
    ...
    .line 46
    iget-object v1, p0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->boolData:Ljava/util/ArrayList;
    ...
    .line 50
    iget-object v1, p0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->stringData:Ljava/util/ArrayList;
...
.method public final writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    .line 155
    iget-object v12, v0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->boolData:Ljava/util/ArrayList;
    ...
    .line 165
    iget-object v14, v0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->intData:Ljava/util/ArrayList;
    ...
    .line 175
    iget-object v9, v0, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->stringData:Ljava/util/ArrayList;
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lvendor/qti/ims/configservice/V1_0/SettingsValues;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
